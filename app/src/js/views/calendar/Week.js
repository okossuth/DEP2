...
define(['views/calendar/DaysCollector', 'views/calendar/WeekEmployees', 'views/resources/ResourceBase', 'collections/period/PeriodGroups', 'collections/period/GroupFilters', '_common/ToolsBase', 'ovivo'], function(DaysCollector, WeekEmployees, ResourceBase, PeriodGroups, GroupFilters, ToolsBase) {
  return ResourceBase.extend(_.extend({}, DaysCollector, WeekEmployees, {
    common: {},
