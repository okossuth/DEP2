define(['views/pages/PageBase', 'views/pages/Settings/General', 'views/pages/Settings/ResourceNeed', 'views/pages/Settings/Connections', 'ovivo'], function(PageBase, GeneralView, ResourceNeedView, ConnectionsView) {
