...
define(['views/pages/PageBase', 'views/pages/Settings/General', 'views/pages/Settings/Notifications', 'views/pages/Settings/Availability', 'views/pages/Settings/Timeoff', 'ovivo'], function(PageBase, GeneralView, NotificationsView, AvailabilityView, TimeoffView) {
